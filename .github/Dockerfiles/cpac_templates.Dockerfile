...
COPY surface_resources/28224_Greyordinates/ /opt/dcan-tools/pipeline/global/templates/
COPY surface_resources/8617_Greyordinates/ /opt/dcan-tools/pipeline/global/templates/
